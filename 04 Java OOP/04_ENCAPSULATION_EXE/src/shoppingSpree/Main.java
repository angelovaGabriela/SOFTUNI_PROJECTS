...
public class Main {
    public static void main(String[] args) {
        ...
        for (String element : people) { // Итерирам през масива за да взема част от него
            ...
            try {
                ...
                peopleInfo.put(name, person); // добавям си човека в MAP
        ...
        while (!command.equals("END")) {
            ...
            try {
                //1. от мапа с хората взимам човек, от мапа с продукти - продукт
                Person person = peopleInfo.get(personName);
                Product product = productInfo.get(productName);
                //2. викам метод buyProduct от class Product
