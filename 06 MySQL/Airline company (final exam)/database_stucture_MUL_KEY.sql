insert into countries (name, currency, description)
values  ('Kazakhstan', 'KZT', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem. Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat. Praesent blandit.'),
        ...
        ('Japan', 'JPY', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis. Sed ante. Vivamus tortor. Duis mattis egestas metus. Aenean fermentum. Donec ut mauris eget massa tempor convallis. Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.'),
...
values  ('Airbus A220', 775, 20958.00, 133.94),
...
insert into passengers (first_name, last_name, country_id)
values  ('Daniela', 'Paulot', 4),
        ('Walliw', 'Luty', 12),
        ('Ernst', 'Grenshiels', 5),
        ('Gus', 'Porrett', 28),
        ('Elfrieda', 'Shaefer', 6),
        ...
        ('Kendal', 'Cusack', 33),
        ('Charla', 'Cooke', 30);
insert into flights (flight_code, departure_country, destination_country, airplane_id, has_delay, departure)
values  ('YZ-430', 29, 30, 7, 0, '2023-08-31 07:17:32'),
...
CONSTRAINT `fk_flights_countries_destinations`
